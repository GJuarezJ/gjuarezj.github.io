...
<body>
  ...
  <p class="small">Abre este enlace desde WhatsApp en el teléfono: <strong>https://gjuarezj.github.io/?seed=123456</strong></p>
  ...
  <div id="adminBox" role="region" aria-label="Vista del organizador">
    ...
    <p class="small">Accede con <code>?admin=familia-juarez&seed=123456</code> para ver la tabla completa.</p>
